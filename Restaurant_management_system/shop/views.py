...
MERCHANT_KEY = 'kXQKrr95927172016901';   # Your-Merchant-Key-Here
...
def index(request):
    ...
    bharath = {'allProds': allProds}
    return render(request, 'shop/index.html', bharath)
    ...
    if request.method == "POST":
        ...
        if 'onlinePay' in request.POST:
            ...
            bharath_dict = {
                ...
                'MID': 'kXQKrr95927172016901',  # Your-Merchant-Id-Here
            ...
            bharath_dict['CHECKSUMHASH'] = Checksum.generate_checksum(bharath_dict, MERCHANT_KEY)
            return render(request, 'shop/paytm.html', {'bharath_dict': bharath_dict})
